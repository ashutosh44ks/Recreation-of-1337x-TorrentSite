//to create random time format
let periods=["am", "pm"]
//to create random item names in menuList
let listName=['Movie','Anime','Game','Book', 'Software', 'Documentary', 'Music'];
//to create menu-item-data
let menuList = [
  {
...
//to create table rows using menuList
let rows='';
